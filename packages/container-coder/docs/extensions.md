...
```typescript
import type { ExtensionAPI } from "@buckeyestudio/container-coder";
...
| Package | Purpose |
|---------|---------|
| `@buckeyestudio/container-coder` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
...
```typescript
import { isToolCallEventType } from "@buckeyestudio/container-coder";
...
```typescript
import { isBashToolResult } from "@buckeyestudio/container-coder";
...
```typescript
import { createLocalBashOperations } from "@buckeyestudio/container-coder";
...
```typescript
import { CONFIG_DIR_NAME, type ExtensionAPI } from "@buckeyestudio/container-coder";
...
```typescript
import { SessionManager } from "@buckeyestudio/container-coder";
...
```typescript
import { withFileMutationQueue } from "@buckeyestudio/container-coder";
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@buckeyestudio/container-coder";
...
```typescript
import { createBashTool } from "@buckeyestudio/container-coder";
...
} from "@buckeyestudio/container-coder";
...
```typescript
import { keyHint } from "@buckeyestudio/container-coder";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@buckeyestudio/container-coder";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@buckeyestudio/container-coder";
