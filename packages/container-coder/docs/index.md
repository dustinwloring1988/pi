...
```bash
npm install -g --ignore-scripts @buckeyestudio/container-coder
```
...
```bash
npm uninstall -g @buckeyestudio/container-coder
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @buckeyestudio/container-coder`, `yarn global remove @buckeyestudio/container-coder`, or `bun uninstall -g @buckeyestudio/container-coder`.
