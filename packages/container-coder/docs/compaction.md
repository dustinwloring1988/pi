...
For TypeScript definitions in your project, inspect `node_modules/@buckeyestudio/container-coder/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@buckeyestudio/container-coder";
