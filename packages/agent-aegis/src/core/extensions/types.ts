...
export interface ExtensionContext {
	...
	/** Gracefully shutdown aegis and exit. Available in all contexts. */
	shutdown(): void;
...
export interface ProviderModelConfig {
	...
	reasoning: boolean;
	/** Maps aegis thinking levels to provider/model-specific values; null marks a level unsupported. */
