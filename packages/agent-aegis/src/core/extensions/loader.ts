 ...
 *
 * Checks for:
 * 1. package.json with "piConfig.extensions" field -> returns declared paths
 * 2. index.ts or index.js -> returns the index file
 *
 * Returns resolved paths or null if no entry points found.
 */
function resolveExtensionEntries(dir: string): string[] | null {
	// Check for package.json with "piConfig" field first
 ...
 * 3. Subdirectory with package.json: `extensions/* /package.json` with "piConfig" field → load what it declares
 *
