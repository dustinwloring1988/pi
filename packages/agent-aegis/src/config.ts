...
export const PACKAGE_NAME: string = pkg.name || "@buckeyestudio/agent-aegis";
export const APP_NAME: string = piConfigName || "aegis";
export const APP_TITLE: string = piConfigName ? APP_NAME : "aegis";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".aegis";
...
const DEFAULT_SHARE_VIEWER_URL = "https://github.com/buckeyestudio/agent-aegis";
